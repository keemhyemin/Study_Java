...
public class Ex04_ImageStr {
	...
	// 원본 이미지를 준비해서 이미지를 읽어 온 다음 => 다른 이름으로 다시 출력
	public static void main(String[] args) throws IOException {
		FileInputStream fis = new FileInputStream("D:\\Study_JAVA\\WorkSpace\\12.IO_FileTest\\pic.jpg");
		FileOutputStream fos = new FileOutputStream("D:\\Study_JAVA\\WorkSpace\\12.IO_FileTest\\pic_copy.jpg");
		int data, cnt = 0; // data: byte 단위로 쪼개진 데이터를 하나씩 읽어와서 저장, cnt는 몇번이나 파일을 읽는지
